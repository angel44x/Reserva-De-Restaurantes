            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg seleccionarTipo">
                    ...
                    <option value="fisico">Alimento</option>            
            ...
            <div class="detallesFisicos" style="display:none">
              ...
              <!-- Hora -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-3">
                    <input class="form-control input-lg" type="text" value="Hora" readonly>
                  </div>

                  <div class="col-xs-9">
                    <input class="form-control input-lg tagsInput detalleHora" data-role="tagsinput" type="text" placeholder="Separe valores con coma">
                  </div>
           ...
           <!--=====================================
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4 col-xs-12">
                ...
                <div class="panel">HORAS DE ENTREGA</div>
           ...
           <!--=====================================
            ...
            <div class="form-group" style="display: none;">
              ...
              <select class="form-control input-lg selActivarOferta">
                ...
                <option value="oferta">No tiene oferta</option>
                <option value="">Activar oferta</option>
