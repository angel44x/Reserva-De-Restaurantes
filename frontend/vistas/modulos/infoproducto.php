			...
			?>
				...
				<?php
					...
					if($infoproducto["precio"] == 0){
						...
						echo '<h2 class="text-muted">S/.4</h2>';
					...
					if($infoproducto["precio"]==0){
						...
						if(isset($_SESSION["validarSesion"]) && $_SESSION["validarSesion"] == "ok"){
							...
							if($infoproducto["tipo"]=="virtual"){
								...
								echo '<button class="btn btn-default btn-block btn-lg backColor agregarGratis" idProducto="'.$infoproducto["id"].'" idUsuario="'.$_SESSION["id"].'" tipo="'.$infoproducto["tipo"].'" titulo="'.$infoproducto["titulo"].'">COMPRAR AHORA</button>

									<button class="btn btn-default btn-block btn-lg backColor"  href="#modalComprarAhora">	AÑADIR AL CARRITO</button>
									<br>
							...
							echo '<a href="#modalIngreso" data-toggle="modal">
								...
								<button class="btn btn-default btn-block btn-lg backColor">	COMPRAR AHORA</button>
								<button class="btn btn-default btn-block btn-lg backColor"  href="#modalComprarAhora">	AÑADIR AL CARRITO</button>
						...
						if($infoproducto["tipo"]=="virtual"){
							...
							if($infoproducto["oferta"] != 0){
									...
									echo '<button class="btn btn-default btn-block btn-lg backColor"  href="#modalComprarAhora">COMPRAR AHORA</button><button class="btn btn-default btn-block btn-lg backColor agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precioOferta"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';

								}else{

									echo '<button class="btn btn-default btn-block btn-lg backColor"  href="#modalComprarAhora">COMPRAR AHORA</button>
